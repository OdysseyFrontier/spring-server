create table enjoytrip.attraction_info
(
    ...
    constraint attraction_to_content_type_id_fk
        foreign key (content_type_id) references enjoytrip.content_type (content_type_id),
...
create index attraction_to_content_type_id_fk_idx
    on enjoytrip.attraction_info (content_type_id);

create index attraction_to_gugun_code_fk_idx
    on enjoytrip.attraction_info (gugun_code);

create index attraction_to_sido_code_fk_idx
    on enjoytrip.attraction_info (sido_code);
