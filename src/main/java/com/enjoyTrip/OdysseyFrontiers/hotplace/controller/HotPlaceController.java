...
public class HotPlaceController {
    ...
    @PostMapping("/write")
	public ResponseEntity<?> writeHotPlace(
		...
		try {
			...
			System.out.println("글은 저장함");
			file.transferTo(new File("img/uploads/hotplace/" + contendId));
			
			System.out.println("파일저장함");
			hotPlaceDto.setFirstImage("http://localhost/img/uploads/hotplace/" + contendId );
